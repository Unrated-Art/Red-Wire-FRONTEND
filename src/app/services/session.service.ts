...
export class SessionService {
  ...
  public addSession(session: Session, idFormation: number): Observable<Session> {
    return this.http.post<Session>(`${this.apiServerUrl}/api/session/add/${idFormation}`, session);
  }
